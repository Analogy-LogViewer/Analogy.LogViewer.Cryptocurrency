...
namespace Analogy.LogViewer.Cryptocurrency.IAnalogy
{
    ...
    {
        protected override string RepositoryURL { get; set; } = "https://api.github.com/repos/Analogy-LogViewer/Analogy.LogViewer.Cryptocurrency";
        ...
        public override string Name { get; set; } = "CryptoCurrency for Analogy Log Viewer";
